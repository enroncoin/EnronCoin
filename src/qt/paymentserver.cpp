...
const QString BITCOIN_IPC_PREFIX("enron:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click enron: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start enron: click-to-pay handler");
    else
...
{
    // clicking on enron: URLs creates FileOpen events on the Mac:
