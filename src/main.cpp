...
// Copyright (c) 2013 The Enroncoin developers
...
uint256 hashGenesisBlock("0x00000e813a579c4d0168f4ee3f8c652b40c1cad9636b651d514364d709ffbb73");
static const unsigned int timeGenesisBlock = 1399168346;
...
const string strMessageMagic = "Enroncoin Signed Message:\n";
...
static const int64 nPremineBlockRewardCoin = 10000000000 * COIN;
static const int64 nBlockRewardStartCoin = 1 * COIN;
static const int64 nBlockRewardMinimumCoin = 1 * COIN;

static const int64 nTargetTimespan = 5 * 60; // 10 minutes
static const int64 nTargetSpacing = 60 * 60; // 30 seconds
...
int64 static GetBlockValue(int nHeight, int64 nFees, unsigned int nBits)
{
    ...
    if (nHeight == 1)
    {
        return nPremineBlockRewardCoin;
    }
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000cda021af180c53d18190996f2f41342c38249eafe6a7711d9924e2df4dd");
    }
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "5/3/2014, today.com,  Man jailed 13 years after sentence asks family to 'keep praying; keep hope'";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 112;
        block.nTime    = 1399170479;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3569276;

        if (fTestNet)
        {
            block.nTime    = 1399168346;
            block.nNonce   = 2237298;
        }
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xebebc31712299e696bf04c72d6ba68dd749550b24f71cf7c5d260b77bd8cbb87"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("EnroncoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("EnroncoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("EnroncoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("enroncoin-miner");
    ...
    try { loop {
        ...
        printf("Running EnroncoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("EnroncoinMiner terminated\n");
        throw;
    }
}
